...
--Only Change from part 1 is below
SELECT MIN(SN1.SeatNumber) -- Doing Min because the higher number returned will be the last seat (922) which we know is not ours
FROM SeatNumbers SN1
LEFT JOIN SeatNumbers SN2 ON SN1.SeatNumber = SN2.SeatNumber - 1 -- Seat to the + 1 of "mine"
WHERE SN2.SeatNumber IS NULL