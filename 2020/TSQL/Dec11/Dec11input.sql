USE tempdb
GO
CREATE OR ALTER VIEW dbo.Dec11Input
AS
/*
Nice tester
.........
...
L.LLLLLLLLLLLLLLLLLLLLLLLL.LLLLL.LLLLLLL.LL.LLLLLLLLLLLLLLLLLLLLLLLLLLLLL.LLLLLLLLLLLLLL.LLL..LLLL' AS InputString
)
SELECT
	REPLACE(Input.InputString, CHAR(0xD) + CHAR(0xA), '') AS Input,
	CHARINDEX(CHAR(0xD), Input.InputString) - 1 AS Cols,
	LEN(REPLACE(Input.InputString, CHAR(0xD) + CHAR(0xA), '')) / (CHARINDEX(CHAR(0xD), Input.InputString) - 1) AS Rc
FROM Input
GO
