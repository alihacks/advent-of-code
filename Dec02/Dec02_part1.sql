...
SplitWithCounts AS (
	SELECT
		*,
		LEN(SplitInput.Password) - LEN(REPLACE(SplitInput.Password, SplitInput.Letter, '')) AS LetterCount
	FROM SplitInput
)
SELECT COUNT(*) AS Answer
FROM SplitWithCounts
WHERE
	SplitWithCounts.LetterCount BETWEEN SplitWithCounts.MinCount AND SplitWithCounts.MaxCount